                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>{{ $category->slug }}</td>
                                    <td>
                                        <a href="{{ route('admin.editcategories',['category_slug' => $category->slug]) }}"><i class="fa fa-edit fa-2x"></i></a> <span class="" style="position: relative;bottom:5px; padding: 0 5px;">||</span> 
