            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="" class="form-horizontal" wire:submit.prevent="addProduct" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Prouct Name</label>
                                <div class="col-md-4">
                                    <input type="text" placeholder="Prouct Name" class="form-control input-md" wire:model="name" wire:keyup="generateSlug">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-4 control-label">Proudct Image</label>
                                <div class="col-md-4">
