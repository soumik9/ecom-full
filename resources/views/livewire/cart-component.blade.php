		...
		<div class="container">
			...
			<div class=" main-content-area">
				...
				<div class="wrap-iten-in-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="quantity">
								<div class="quantity-input">
									<input type="text" name="product-quatity" value="{{$item->qty}}" data-max="120" pattern="[0-9]*" >	<a class="btn btn-increase" href="#" wire:click.prevent="increaseQuantity('{{$item->rowId}}')"></a>
					...
					@else
						<h4>No item added in the cart</h4>									
					@endif
				</div>
